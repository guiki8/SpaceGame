...
if global.pagina == 1 and global.regolito_inpecionado {
	...
	texto2 = "Estudos recentes têm demonstrado que o regolito lunar também contém água em forma de gelo, encontrada em regiões permanentemente sombreadas. No Regolito Lunar podem ser encontrados elementos como oxigênio, silício, e o raro Hélio-3."
	...
	texto2 = "Ao contrário das rochas basálticas escuras encontradas nos mares lunares, formadas por erupções vulcânicas, as rochas das terras altas apresentam uma coloração mais clara e são resultado de processos de cristalização que ocorreram nas primeiras fases de formação do satélite natural da Terra."
} else {
	texto = " "
	texto2 = " "
}
